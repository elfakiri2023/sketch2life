...
{#if loading}
	<section class="card flex items-center justify-center w-full">
		<div class="p-4">
			<div class="flex items-center justify-center h-[550px] w-[550px] bg-gray-300 rounded animate-pulse">
